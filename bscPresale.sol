...
contract SuperPepePresale is Ownable {
    ...
    address public wallet = payable(0xc59Bb9Cb0c781D7DbFE863d1f88ad5EA7d3CF5Aa);
    ...
    //TO UPDATE RATES
    function changeRate(uint256 _usdtRate, uint256 _bnbToUsd, uint256 divider, uint256 usdtDiv) public onlyOwner {
