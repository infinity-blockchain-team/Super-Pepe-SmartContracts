...
contract SuperPepePresale is Ownable {
    ...
    address public wallet = payable(0xbB913e65c9D39300B74Cc434231ca815B3FA50e4);
    ...
    function startPresale(uint256 amount) public onlyOwner{
        require(!hasPresaleStarted,"Presale has started");
    ...
    function updatePresaleAllocation(uint256 amount) public onlyOwner{
        require(amount > tokensSold,"This much is already sold");
        uint256 finalDeposit = amount.sub(tokensSold);
        claimableTokens= finalDeposit;
    }
